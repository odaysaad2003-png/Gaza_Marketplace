    ...
    return (
        <MainContainer className="py-10 sm:py-14">
            <div className="mx-auto max-w-6xl space-y-8">
                <section className="overflow-hidden rounded-[2rem] border border-border/70 bg-card/85 p-6 shadow-sm shadow-black/[0.03] sm:p-8">
                    <div className="grid gap-6 lg:grid-cols-[1fr_0.75fr] lg:items-center">
                        <div className="space-y-5">
                            <Badge
                                variant="secondary"
                                className="rounded-full border border-border/70 bg-secondary/70 px-4 py-2 text-primary"
                            >
                        ...
                        <Card className="rounded-3xl border-border/70 bg-muted/30 p-5 shadow-none">
                ...
                <div className="grid gap-6 lg:grid-cols-[1fr_22rem] lg:items-start">
                    ...
                    <aside className="space-y-4 lg:sticky lg:top-24">
                        <Card className="rounded-[2rem] border-border/70 bg-card/85 p-5 shadow-sm shadow-black/[0.03]">
                        ...
                        <Card className="rounded-[2rem] border-border/70 bg-primary p-5 text-primary-foreground shadow-sm shadow-primary/20">
